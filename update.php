...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_course)){
        $level_err = "Please enter a course.";     
    } else{
        $course = $input_course;
    }
    ...
    if(empty($name_err) && empty($course_err) && empty($level_err)){
        ...
        $sql = "UPDATE students SET name=?, course=?, level=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssi", $param_name, $param_course, $param_level, $param_id);
